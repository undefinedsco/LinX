...
test.describe('Files-standard supporting modules real Pod smoke', () => {
  ...
  test('persists a Contact and walks Settings and Model Services with keyboard interaction', async ({ page }) => {
    ...
    await expect(page.locator('[data-micro-app-id="settings"]')).toBeVisible({ timeout: 30_000 })
    ...
    await expect(page.locator('[data-micro-app-id="model-services"]')).toBeVisible({ timeout: 30_000 })
