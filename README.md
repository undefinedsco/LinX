...
- **Solid & 数据层**：`@linx/models`（drizzle-solid + drizzle-orm）统一管理所有 Pod 读写；`@inrupt/solid-client(-authn)`、`@inrupt/solid-ui-react`、`@inrupt/vocab-common-rdf`、`@comunica/*` 提供会话和 SPARQL 支撑。
