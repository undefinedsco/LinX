...
test('CLI app delegates Pi/TUI command orchestration to a shell command module', () => {
  ...
  assert.doesNotMatch(piCliCommandSource, /\bdefaultPiCommand\b/, 'default command descriptor should not keep Pi naming')
  assert.match(piCliCommandSource, /\brunLinxDefaultCommand\b/, 'default command runner should be LinX-named')
  assert.doesNotMatch(piCliCommandSource, /\brunPiCommand\b/, 'default command runner should not keep Pi naming')
  assert.match(piCliCommandSource, /\bbuildLinxDefaultCommand\b/, 'default command builder should be LinX-named')
  assert.doesNotMatch(piCliCommandSource, /\bbuildPiCommand\b/, 'default command builder should not keep Pi naming')
  assert.match(piCliCommandSource, /\bLinxDefaultCommandBaseArgs\b/, 'default command argv base type should be LinX-named')
  assert.doesNotMatch(piCliCommandSource, /\bPiCommandArgs\b/, 'default command argv base type should not keep Pi naming')
  assert.match(piCliCommandSource, /\bRunLinxDefaultCommandOptions\b/, 'default command options type should be LinX-named')
  assert.doesNotMatch(piCliCommandSource, /\bRunPiCommandOptions\b/, 'default command options type should not keep Pi naming')
  assert.match(piCliCommandSource, /\bassertLinxDefaultCliSessionSelectorCompatibility\b/, 'default command selector guard should be LinX-named')
  assert.doesNotMatch(piCliCommandSource, /\bassertLinxPiCliSessionSelectorCompatibility\b/, 'default command selector guard should not keep Pi naming')
