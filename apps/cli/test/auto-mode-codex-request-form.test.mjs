...
test.before(async () => {
  const loaded = await loadAutoModeModule('lib/auto-mode/codex-request-form.ts')
...
test('CodexRequestForm advances across questions and submits one combined answer record', () => {
  ...
  for (const char of 'Ship a Codex-like auto-mode TUI') {
  ...
  assert.deepEqual(result.answers, {
    ...
    goal: { answers: ['Ship a Codex-like auto-mode TUI'] },
  })
})
