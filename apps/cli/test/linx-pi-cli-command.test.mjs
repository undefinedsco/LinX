...
test('runPiCommand cleanup delegates interactive stop to restart-aware shell lifecycle', () => {
  const source = readFileSync(`${cliRoot}/src/lib/linx-pi-cli-command.ts`, 'utf8')
