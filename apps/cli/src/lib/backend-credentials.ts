...
export async function loadOrPromptBackendCredential(
  backend: ProviderCredentialBackend,
  input: {
    promptCredential: (details: BackendCredentialInput) => Promise<BackendCredentialEntry | null | undefined>
    runtime?: BackendCredentialRuntime
  ...
  return promptAndSaveBackendCredential(backend, {
