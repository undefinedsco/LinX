...
export const SOLID_LINX_WEB_ACCESS_CONFIG_FILE_NAME = 'pi-web-access.json'
...
export function getSolidLinxWebAccessConfigPath(): string {
  return join(getSolidLinxAppDir(), SOLID_LINX_WEB_ACCESS_CONFIG_FILE_NAME)
}
