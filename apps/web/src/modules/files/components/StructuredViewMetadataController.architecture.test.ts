...
describe('Structured view metadata controller architecture boundary', () => {
  it('keeps view metadata hydration and autosave out of the structured preview container', () => {
    ...
    expect(controllerSource).toContain('localViewMetadataDirty')
    expect(controllerSource).toContain('markStructuredViewMetadataDirty')
    expect(controllerSource).toContain('clearStructuredViewMetadataDirty')
  ...
  it('keeps structured view state store bindings out of the structured preview container', () => {
    ...
    expect(viewStateControllerSource).toContain('structuredViewDirtyDocuments.has(file.uri)')
