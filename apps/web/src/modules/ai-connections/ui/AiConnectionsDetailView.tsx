...
import type { ModelListProjection } from '../domain/ai-connections-projection'

export interface AiConnectionsProviderView {
  id: string
  name: string
  description?: string
  homeUrl?: string
...
export interface AiConnectionsDetailViewProps {
  provider: AiConnectionsProviderView | null
...
export function AiConnectionsDetailView({
  provider,
  queryError,
  mutationError,
  localApiKey,
