...
import { AiConnectionsDetailView, type AiConnectionsDetailViewProps } from './AiConnectionsDetailView'

function renderView(overrides: Partial<AiConnectionsDetailViewProps> = {}) {
  const props: AiConnectionsDetailViewProps = {
    provider: {
      id: 'openai',
      name: 'OpenAI',
  ...
  render(<AiConnectionsDetailView {...props} />)
}

describe('AiConnectionsDetailView tooltip accessibility', () => {
...
describe('AiConnectionsDetailView model row accessibility', () => {
