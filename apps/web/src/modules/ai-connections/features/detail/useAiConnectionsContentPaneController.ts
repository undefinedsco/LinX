...
import { projectModelList } from '../../domain/ai-connections-projection'
import type { AIModel } from '../../domain/types'
import type { ModelEditorDialogProps, ModelEditorValue } from '../../ui/ModelEditorDialog'
import type { AiConnectionsDetailViewProps } from '../../ui/AiConnectionsDetailView'
import { getModelProviderAvatar } from '../../ui/provider-visuals'

export interface AiConnectionsContentPaneController {
  detailViewProps: AiConnectionsDetailViewProps
...
export function useAiConnectionsContentPaneController(): AiConnectionsContentPaneController {
  const { toast } = useToast()
  const { providers, updateProvider, error: queryError = null } = useAiConnections()
